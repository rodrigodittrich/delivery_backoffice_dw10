...
class PaymentTypeFormModal extends StatefulWidget {
  ...
  const PaymentTypeFormModal({ Key? key, required this.model, required this.controller}) : super(key: key);
...
class _PaymentTypeFormModalState extends State<PaymentTypeFormModal> {
  ...
  final acronEC = TextEditingController();
  var enabled = false;
  ...
  void initState() {
    ...
    if(paymentModel != null) {
      ...
      acronEC.text = paymentModel.acronym;
