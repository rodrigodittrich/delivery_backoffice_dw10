...
mixin _$ProductDetailController on ProductDetailControllerBase, Store {
  ...
  Future<void> loadProduct({int? id}) {
    return _$loadProductAsyncAction.run(() => super.loadProduct(id: id));
  }
  ...
  void save(
    ...
    final _$actionInfo = _$ProductDetailControllerBaseActionController
        .startAction(name: 'ProductDetailControllerBase.save');
    try {
      return super.save(name: name, price: price, description: description);
    } finally {
